    ...
    var redison = Object.create(redisClient, {
        ...
        stopListener:{
            ...
            value:function(){
                ...
                if(arguments.length > 0){
                    if(arguments.indexOf("subscribe") !== -1){
                        this.removeListener("subscribe", this.cbInterface.subscribe.bind(this));
                    }
                    if(arguments.indexOf("psubscribe") !== -1){
                        this.removeListener("psubscribe", this.cbInterface.psubscribe.bind(this));
                    }
                    if(arguments.indexOf("message") !== -1){
                        this.removeListener("message", this.cbInterface.message.bind(this));
                    }
                    if(arguments.indexOf("pmessage") !== -1){
                        this.removeListener("pmessage", this.cbInterface.pmessage.bind(this));
                    }
                    if(arguments.indexOf("unsubscribe") !== -1){
                        this.removeListener("unsubscribe", this.cbInterface.unsubscribe.bind(this));
                    }
                    if(arguments.indexOf("punsubscribe") !== -1){
                        this.removeListener("punsubscribe", this.cbInterface.punsubscribe.bind(this));
                    }
                    return this;
                }else{
                    this.removeListener("subscribe", this.cbInterface.subscribe.bind(this));
